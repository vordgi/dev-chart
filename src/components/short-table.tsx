...
import { formatShortSummary } from "../core/formatters";
...
export const ShortTable: React.FC<FullTableProps> = ({
  totalWeeks,
  githubActivity,
  gitlabActivity,
  startDate,
  ...
  }, [githubActivity, gitlabActivity, totalWeeks, startDate]);
  ...
  return (
    <>
      <div className="border">
        <svg
          width="100%"
          viewBox={`0 0 ${totalWeeks * 14 + 6} 38`}
